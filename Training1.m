function [subsystemone,MSE1]=Training1(input,output)
Y1=output(:,1);
U=input;
...
opt_temp=optimset(options,'DiffMaxChange',0.001,'DiffMinChange',0.00000001,'Display','iter','Jacobian','off',...
...
toc                    % timing end
MSE1 =resnorm/N_S     % print MSE

save 'model1paras' beta optimcenter Order_y Order_u N_Center D_Center gamma0 ust yst usv ysv N_S N_lag N_input N_output
subsystemone=struct('Order_y',Order_y,'Order_u',Order_u,'N_input',N_input, 'N_output',N_output,'N_Center',N_Center,'D_Center',D_Center,'center',optimcenter,'gamma0',gamma0,'beta',beta);
save 'themodel1' subsystemone;
