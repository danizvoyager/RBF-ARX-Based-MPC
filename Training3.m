function [subsystemthree,MSE3]=Training3(input,output)
Y3=output(:,3);
U=input;
...
opt_temp=optimset(options,'DiffMaxChange',0.0001,'DiffMinChange',0.00000001,'Display','iter','Jacobian','off',...
...
toc                    % timing end
MSE3=resnorm/N_S;     % print MSE

save 'model3paras' beta optimcenter Order_y Order_u N_Center D_Center gamma0 ust yst usv ysv N_S N_lag

subsystemthree=struct('Order_y',Order_y,'Order_u',Order_u,'N_Center',N_Center,'D_Center',D_Center,'center',optimcenter,'gamma0',gamma0,'beta',beta);

save 'themodel3' subsystemthree;
